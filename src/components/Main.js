  ...
  return (
    <main className="main">
      <section className="profile">
        <div className="info">
          <button type="button" className="profile__buttonpict" onClick={()=>onEditAvatar(true)}>
          ...
          <div className="profile__info">
            ...
            <button type="button" className="profile__button" onClick={()=>onEditProfile(true)}>
              <img className="profile__pencil" src={pencil} alt="Редактировать" />
            </button>
            <p className="profile__subtitle">{onUserDescription}</p>
          </div>
        </div>
        <button type="button" className="button" onClick={()=>onAddPlace(true)}>
